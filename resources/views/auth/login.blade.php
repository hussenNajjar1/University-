...
<body style="background: linear-gradient(to left,#250856fc,#16196d);">
    <!-- Main navigation container -->
    <nav style="background: #053550;"
        ...
        <div class="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <button
                ...
                type="button" 
                >
                <a href="" style="font-size: 20px;font-weight: 700;">Idlib Uinversity</a>        
            </button>
            <!-- Right elements -->
            <div class="relative flex items-center">
                ...
                <div class="relative" data-te-dropdown-ref data-te-dropdown-alignment="end">
                    ...
                    <a class="hidden-arrow flex items-center whitespace-nowrap transition duration-150 ease-in-out motion-reduce:transition-none"
                        ...
                        <!-- User avatar -->
                        <img src="imgs/idlib_u.jpg" class="rounded-full"
    ...
    <section class="" style="display: flex; justify-content: center; align-items: center;margin: 140px 10px 0;">
        <div style="width: 900px;background: linear-gradient(to left,#393c809e,#013994fc); padding: 30px;border-radius: 20px;">
            ...
            @csrf
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input 
                                ...
                                placeholder="Email address"   class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                        ...
                        <div class="relative mb-6" data-te-input-wrapper-init>
                            <input 
                                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                id="exampleFormControlInput22" placeholder="Password"    type="password" name="password" required autocomplete="current-password"/>
                        ...
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                                <input
                                    ...
                                    type="checkbox" value="" id="exampleCheck2  " name="remember"  />
                        ...
                        <div class="text-center lg:text-left">
                            <button type="submit" style="background: rgb(4, 24, 71); padding: 5px 10px; width: 100%;"
                                class="inline-block rounded bg-primary px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-white focus:bg-primary-600 "
    ...
    <!--Footer container-->
    <div style="margin-bottom: 159px;"></div>
    <footer class="flex flex-col items-center text-center text-white" style="background-color: #0a4275;">
        <!--Copyright section-->
        <div class="w-full p-4 text-center" style="background-color: rgba(0, 0, 0, 0.718);">
            © 2023 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">Idlib Uinversity</a>
        </div>
    </footer>
</body>
</html>